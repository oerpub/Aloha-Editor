...
(function() {
  ...
  define(['aloha', 'aloha/plugin', 'jquery', 'aloha/ephemera', 'ui/ui', 'ui/button', 'semanticblock/semanticblock-plugin', 'css!exercise/css/exercise-plugin.css'], function(Aloha, Plugin, jQuery, Ephemera, UI, Button, semanticBlock) {
    ...
    activateExercise = function($element) {
      ...
      jQuery('<div>').addClass('solution-controls').addClass('aloha-ephemera').append('<span class="add-solution btn-link">Click here to add an answer/solution</span>').append('<span class="solution-toggle">show solution</span>').appendTo($element);
      if (!$solutions.length) {
    ...
    return Plugin.create('exercise', {
      ...
      init: function() {
        ...
        return semanticBlock.registerEvent('click', '.aloha-oer-block.solution > .type-container > ul > li > span,\
                                              .aloha-oer-block.exercise > .type-container > ul > li > span', function(e) {
          var _this = this;
          e.preventDefault();
          ...
          return jQuery(this).parents('.type-container').find('.dropdown-menu li').each(function(i, li) {
            ...
            if (jQuery(li).children('span').text() === jQuery(_this).text()) {
              return jQuery(li).addClass('checked');
            }
          });
        });

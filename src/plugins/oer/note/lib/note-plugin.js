...
(function() {
  ...
  define(['aloha', 'aloha/plugin', 'jquery', 'aloha/ephemera', 'ui/ui', 'ui/button', 'semanticblock/semanticblock-plugin'], function(Aloha, Plugin, jQuery, Ephemera, UI, Button, semanticBlock) {
